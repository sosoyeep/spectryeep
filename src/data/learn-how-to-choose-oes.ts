...
export const description: Record<Locale, string> = {
  en: 'Choosing the right OES spectrometer is a four-question problem: which base matrices, which elements at which detection level, what daily throughput, and what working environment. This guide walks through each question and maps the answers to JIEBO\'s five OES models — Exquis T4, Exquis T4 Pro, Innovate T5, Noble T7 and Surpass F1.',
  ru: 'Правильный выбор ОЭС-спектрометра — задача из четырёх вопросов: какие базовые матрицы, какие элементы и до какого предела, какая суточная нагрузка, какая рабочая среда. Это руководство разбирает каждый вопрос и сопоставляет ответы с пятью моделями JIEBO — Exquis T4, Exquis T4 Pro, Innovate T5, Noble T7 и Surpass F1.',
  es: 'Elegir el espectrómetro OES correcto es un problema de cuatro preguntas: qué matrices base, qué elementos a qué nivel de detección, cuánto rendimiento diario y qué entorno de trabajo. Esta guía recorre cada pregunta y mapea las respuestas a los cinco modelos OES de JIEBO — Exquis T4, Exquis T4 Pro, Innovate T5, Noble T7 y Surpass F1.',
  ar: 'اختيار جهاز OES المناسب مسألة من أربعة أسئلة: ما المصفوفات الأساسية، وما العناصر وعند أيّ حدّ كشف، وما الإنتاجية اليومية، وما بيئة العمل. يستعرض هذا الدليل كل سؤال ويربط إجابته بأحد موديلات JIEBO الخمسة — Exquis T4 و Exquis T4 Pro و Innovate T5 و Noble T7 و Surpass F1.',
};
  ...
  en: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'For most foundry and metallurgy production work the [Innovate T5](/products/innovate-t5/) (vacuum chamber, Hamamatsu CMOS, 0.0001 % detection limit) is the right answer. For sub-10-ppm work, step up to the [Noble T7](/products/noble-t7/) (constant-temperature chamber ±0.1 °C, accuracy <10 ppm). ',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'In one paragraph: **Exquis T4** is the price-performance single-matrix benchtop. **Innovate T5** is the multi-alloy production workhorse with vacuum chamber and CMOS detection. **Noble T7** adds research-grade trace-element accuracy and a thermostatted chamber.  **Surpass F1** is the mobile OES for field work.',
      ],
    },
    {
  ...
  ru: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Для большинства литейных и металлургических задач [Innovate T5](/ru/products/innovate-t5/) (вакуумная камера, Hamamatsu CMOS, предел 0,0001 %) — правильный ответ. Для работы ниже 10 ppm берите [Noble T7](/ru/products/noble-t7/) (термостат ±0,1 °C, точность <10 ppm). ',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        '**5–10 / смену** → Exquis T4 (настольный) или Innovate T5 (напольный). **20–50 / смену** → Innovate T5 или Noble T7 напольные. **50+ / смену, сертификация** → Noble T7 с термостатом.',
      ],
    },
    {
      heading: 'Вопрос 4 — Какая рабочая среда?',
      paragraphs: [
        'Литейный цех — жаркий, пыльный, электрически шумный. Кондиционируемая QC-лаборатория — нет. Подбирайте прибор под реальное место работы. Вакуумная оптика (T5, T7) устойчивее к пыли и влажности, чем закрытая аргонная камера (T4). Термостат (T7) нужен при колебаниях температуры более 5 °C за смену.',
    ...
    },
    {
      ...
      paragraphs: [
        'Одним абзацем: **Exquis T4** — настольный с лучшей ценой по одной матрице. **Innovate T5** — рабочая лошадка многосплавного производства с вакуумной камерой и CMOS-детектированием. **Noble T7** добавляет исследовательскую точность по следовым элементам и термостат.  **Surpass F1** — мобильный ОЭС для полевых работ.',
      ],
    },
    {
  ...
  es: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Para la mayoría del trabajo de fundición y metalurgia el [Innovate T5](/es/products/innovate-t5/) (cámara al vacío, Hamamatsu CMOS, límite 0,0001 %) es la respuesta. Para sub-10 ppm suba al [Noble T7](/es/products/noble-t7/) (cámara termostatizada ±0,1 °C, precisión <10 ppm). ',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        '**5–10 / turno** → Exquis T4 (mesa) o Innovate T5 (de pie). **20–50 / turno** → Innovate T5 o Noble T7 de pie. **50+ / turno, certificación** → Noble T7 con cámara termostatizada.',
      ],
    },
    {
      heading: 'Pregunta 4 — ¿Qué entorno de trabajo?',
      paragraphs: [
        'El piso de fundición es caliente, polvoriento y eléctricamente ruidoso. Un laboratorio QC climatizado no lo es. Adapte el equipo al lugar real. Una cámara óptica al vacío (T5, T7) resiste mejor polvo y humedad que una cámara de argón sellado (T4). Una cámara termostatizada (T7) es necesaria si la temperatura ambiente varía más de 5 °C durante el turno.',
    ...
    },
    {
      ...
      paragraphs: [
        'En un párrafo: **Exquis T4** es el de mesa precio-rendimiento para una sola matriz. **Innovate T5** es el caballo de batalla multi-aleación con cámara al vacío y detección CMOS. **Noble T7** añade precisión de trazas de grado investigación y cámara termostatizada.  **Surpass F1** es el OES móvil para trabajo de campo.',
      ],
    },
    {
  ...
  ar: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'لمعظم أعمال المسابك والمعادن يكون [Innovate T5](/ar/products/innovate-t5/) (غرفة مفرّغة وكواشف Hamamatsu CMOS وحدّ كشف 0.0001 %) هو الإجابة. للأعمال دون 10 ppm ارتقِ إلى [Noble T7](/ar/products/noble-t7/) (غرفة ثابتة الحرارة ±0.1 °م ودقّة <10 ppm). ',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        '**5–10 / وردية** → Exquis T4 (مكتبي) أو Innovate T5 (أرضي). **20–50 / وردية** → Innovate T5 أو Noble T7 الأرضيان. **50+ / وردية واعتماد** → Noble T7 مع غرفة ثابتة الحرارة.',
      ],
    },
    {
      heading: 'السؤال 4 — ما بيئة العمل؟',
      paragraphs: [
        'أرضيات المسابك حارّة ومُغبَرّة وذات ضوضاء كهربائية، أمّا مختبر الجودة المكيَّف فلا. اختر الجهاز للمكان الذي سيعمل فيه فعلاً. تتحمّل الغرفة البصرية المفرّغة (T5 و T7) الغبار والرطوبة أكثر من غرفة الأرغون المغلقة (T4). الغرفة الثابتة الحرارة (T7) ضرورية عند تذبذب درجة حرارة المحيط بأكثر من 5 °م خلال الوردية.',
    ...
    },
    {
      ...
      paragraphs: [
        'في فقرة واحدة: **Exquis T4** هو المكتبي ذو السعر-الأداء الأفضل لمصفوفة واحدة. **Innovate T5** هو خيار الإنتاج متعدّد السبائك بغرفة مفرّغة وكشف CMOS. يضيف **Noble T7** دقّةً بحثية للعناصر النزرة وغرفة مُنظِّمة حرارياً.  **Surpass F1** هو OES المتنقّل للأعمال الميدانية.',
      ],
    },
    {
...
export const faq: Record<Locale, Array<{ q: string; a: string }>> = {
  en: [
    ...
    { q: 'Do I need PMT or can CMOS do the job?', a: 'For typical foundry, steel-mill and metallurgy production work, modern CMOS detectors (Innovate T5, Noble T7) reach 0.0001 % detection limits — sufficient for production-grade trace analysis. ' },
    { q: 'How much argon will the instrument actually use?', a: 'Modern vacuum-chamber instruments (T5, T7) consume approximately 0.5–2 L/min in standby and 3–5 L/min during sparking. The sealed-cycle design of the Exquis T4 reduces consumption further. Plan on one 40 L argon cylinder per 2–4 weeks of normal QC use.' },
    ...
    { q: 'Can JIEBO ship outside China?', a: 'Yes — current installations in 40+ countries across the Middle East, Africa, Southeast Asia, Latin America and CIS. Standard 15-day lead time, CE/CB certificates and door-to-door logistics handled by the Wuxi sales team. Talk to us on WhatsApp.' },
  ],
  ru: [
    ...
    { q: 'Нужен ли ФЭУ или достаточно CMOS?', a: 'Для типичных литейных, сталелитейных и металлургических задач современные CMOS-детекторы (Innovate T5, Noble T7) дают предел 0,0001 % — этого достаточно для производственной следовой работы. ' },
    { q: 'Каков реальный расход аргона?', a: 'Современные вакуумные приборы (T5, T7) расходуют около 0,5–2 л/мин в режиме ожидания и 3–5 л/мин при разряде. Закрытая схема Exquis T4 снижает расход ещё больше. Рассчитывайте на один 40-литровый баллон аргона на 2–4 недели нормальной QC-работы.' },
    ...
    { q: 'Поставляет ли JIEBO за пределы Китая?', a: 'Да — действующие установки в 40+ странах Ближнего Востока, Африки, ЮВА, Латинской Америки и СНГ. Стандартный срок 15 дней, сертификаты CE/CB и доставка «от двери до двери» — через коммерческую службу в Уси. Пишите нам в WhatsApp.' },
  ],
  es: [
    ...
    { q: '¿Necesito PMT o me sirve CMOS?', a: 'Para fundición, acería y metalurgia de producción típica, los CMOS modernos (Innovate T5, Noble T7) alcanzan límite de 0,0001 % — suficiente para trazas de producción. ' },
    { q: '¿Cuánto argón usará realmente el equipo?', a: 'Los equipos modernos al vacío (T5, T7) consumen ~0,5–2 L/min en reposo y 3–5 L/min al chispear. El diseño sellado del Exquis T4 reduce aún más el consumo. Calcule un cilindro de 40 L cada 2–4 semanas de QC normal.' },
    ...
    { q: '¿JIEBO envía fuera de China?', a: 'Sí — instalaciones actuales en 40+ países en Medio Oriente, África, Sudeste Asiático, América Latina y CEI. Plazo estándar 15 días, certificados CE/CB y logística puerta a puerta gestionados por el equipo comercial en Wuxi. Escríbanos por WhatsApp.' },
  ],
  ar: [
    ...
    { q: 'هل أحتاج PMT أم يكفيني CMOS؟', a: 'لأعمال المسابك ومصانع الصلب والإنتاج المعدني المعتادة، تصل كاشفات CMOS الحديثة (Innovate T5 و Noble T7) إلى حدود كشف 0.0001 % — وهو يكفي لقياس العناصر النزرة بدرجة الإنتاج. ' },
    { q: 'كم سيستهلك الجهاز من الأرغون فعلاً؟', a: 'تستهلك الأجهزة المفرّغة الحديثة (T5 و T7) نحو 0.5–2 لتر/دقيقة في الاستعداد، و3–5 لتر/دقيقة أثناء الشرارة. يخفّض تصميم Exquis T4 المغلق الاستهلاك أكثر. خطّط لاسطوانة أرغون 40 لتراً كلّ 2–4 أسابيع من استخدام QC اعتيادي.' },
    ...
    { q: 'هل تشحن JIEBO خارج الصين؟', a: 'نعم — تركيبات حالية في أكثر من 40 دولة عبر الشرق الأوسط وأفريقيا وجنوب شرق آسيا وأمريكا اللاتينية وكومنولث الدول المستقلّة. مدّة قياسية 15 يوماً وشهادات CE/CB وشحن من الباب إلى الباب يتولّاها فريق المبيعات في ووشي. تواصل معنا عبر واتساب.' },
  ],
};
