...
export const product: ProductRecord = {
  ...
  specs: [
    ...
    { labelKey: 'wavelength', value: '140–680 nm' },
    { labelKey: 'detector', value: 'Hamamatsu CMOS, individually configurable per channel' },
    { labelKey: 'light_source', value: 'All-digital pulse-synthesis programmable spark source' },
    ...
    { labelKey: 'dimensions', value: '590 × 790 × 350 mm' },
    { labelKey: 'weight', value: '78 kg' },
  ],
  overview: {
