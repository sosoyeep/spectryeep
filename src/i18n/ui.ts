...
export const ui: Record<Locale, Record<UIKey, string>> = {
  en: {
    ...
    'hero.lede': 'JIEBO Instrument designs and manufactures CMOS full-spectrum optical emission spectrometers, carbon-sulfur analyzers, and custom material-analysis solutions. Trusted by metallurgy and aerospace customers in 40+ countries.',
    ...
    'section.products_lede': 'Eleven production models across CMOS optical emission, high-frequency infrared carbon-sulfur and ONH combustion analysis, and handheld XRF / LIBS. Each ships with full calibration, training, and a 12-month warranty.',
  ...
  ru: {
    ...
    'hero.lede': 'JIEBO Instrument разрабатывает и производит оптико-эмиссионные спектрометры на КМОП-детекторах, анализаторы углерода и серы, а также индивидуальные решения для анализа материалов. Нам доверяют металлургические и аэрокосмические предприятия в более чем 40 странах.',
    ...
    'section.products_lede': 'Одиннадцать серийных моделей: КМОП-спектрометры ОЭС, высокочастотные ИК-анализаторы C/S и O/N/H, ручные XRF / LIBS. Каждый прибор поставляется с полной калибровкой, обучением и гарантией 12 месяцев.',
  ...
  es: {
    ...
    'hero.lede': 'JIEBO Instrument diseña y fabrica espectrómetros de emisión óptica CMOS de espectro completo, analizadores de carbono y azufre y soluciones a medida para análisis de materiales. Clientes de metalurgia y aeroespacial en más de 40 países confían en nosotros.',
    ...
    'section.products_lede': 'Once modelos en producción: espectrómetros OES con CMOS, analizadores de carbono-azufre y O/N/H por combustión, y equipos portátiles XRF / LIBS. Cada equipo se envía con calibración completa, capacitación y 12 meses de garantía.',
  ...
  ar: {
    ...
    'hero.lede': 'تصمّم JIEBO Instrument وتُصنّع أجهزة طيف الانبعاث الضوئي بتقنيتي CMOS، إضافة إلى محلّلات الكربون والكبريت وحلول مخصّصة لتحليل المواد. تعتمد علينا شركات معدنية وصناعات طيران في أكثر من 40 دولة.',
    ...
    'section.products_lede': 'أحد عشر موديلاً إنتاجياً تشمل مطيافيات OES بمستشعرات CMOS ومحلّلات الكربون والكبريت وO/N/H بالاحتراق وأجهزة XRF / LIBS المحمولة. يُسلّم كل جهاز بمعايرة كاملة وتدريب وضمان 12 شهراً.',
